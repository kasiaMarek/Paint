...
public class MouseMove extends MouseMotionAdapter {
    ...
    public void mouseDragged(MouseEvent e) {
        if(Surface.getMode() == Mode.ELIPSE)
            Surface.addPath(Mouse.circle.resizeCircle(e.getX() - Mouse.sx, e.getY() - Mouse.sy));
        if(Surface.getMode() == Mode.RECTANGLE)
            Surface.addPath(Mouse.rectangle.resizeRectangle(e.getX() - Mouse.sx, e.getY() - Mouse.sy));
